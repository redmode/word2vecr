                 ...
                 double threshold0)
{
  ...
  w2p::min_count = min_count0;
  w2p::threshold = (float)threshold0;


  strcpy(w2p::train_file, train_file0);
  strcpy(w2p::output_file, output_file0);
...
//' @useDynLib word2vecr
// [[Rcpp::export]]
void CWrapper_word2phrase(std::string train_file_,
                          std::string output_file_,
                          int min_count,
                          double threshold)
{

  char* train_file = (char*)train_file_.c_str();
  char* output_file = (char*)output_file_.c_str();
